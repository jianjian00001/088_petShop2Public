<template>
  <div class="box11">
    ...
    <div style="margin: 18% auto;margin-right: 17%;background-color: #fff; width: 350px; height: 350px; padding: 20px; border-radius: 10px">
    ...
    login() {
      this.$refs['userForm'].validate((valid) => {
        if (valid) {  // 表单校验合法
          ...
          this.$axios.register(this.user).then(res => {
